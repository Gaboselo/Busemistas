...
class CamionetaModelo {
  ...
  factory CamionetaModelo.fromDoc(DocumentSnapshot doc) {
    ...
    return CamionetaModelo(
      ...
      // Fallback: si 'ubicacion' (GeoPoint) no existe, construirlo desde
      // los campos numericos 'latitud'/'longitud' que escribe el conductor.
      ubicacion: _geopointFromDoc(data),
  ...
  /// Lee el GeoPoint del documento.
  /// Primero intenta el campo 'ubicacion' (GeoPoint nativo).
  /// Si es null, construye el GeoPoint desde 'latitud' y 'longitud' numericos.
  static GeoPoint? _geopointFromDoc(Map<String, dynamic> data) {
    final raw = data['ubicacion'];
