...
class _RegistroVistaState extends State<RegistroVista> {
    ...
    switch (resultado) {
      case ResultadoVerificacion.yaRegistrado:
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          content: Text('Esta cédula ya tiene cuenta. Inicia sesión.'),
      ...
      case ResultadoVerificacion.error:
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(auth.mensajeError ?? 'Error al verificar cédula.'),
  ...
  void _mostrarDialogoNoAutorizado(BuildContext context) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        title: const Text('Cédula no autorizada'),
        content: const Text(
            'Tu cédula no figura en las listas institucionales de la USM.\n'
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(_paso == 1 ? 'Verificar Cédula' : 'Crear Cuenta'),
    ...
    return Form(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        ...
        FilledButton.icon(
          ...
          label: Text(cargando ? 'Verificando...' : 'Verificar Cédula'),
