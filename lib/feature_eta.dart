...
//    CALCULAR ETA
// ==========================================
Map<String, dynamic> calcularETA(
  double latCamioneta,
  double lngCamioneta, {
  double factorTrafico = 1.0,
}) {
  ...
  double etaCalifornia =
      (distanciaCalifornia / VELOCIDAD_PROMEDIO) * 60 * factorTrafico;
  double etaUniversidad =
      (distanciaUniversidad / VELOCIDAD_PROMEDIO) * 60 * factorTrafico;
